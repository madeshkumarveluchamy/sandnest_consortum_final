...
const SustainableGreenBuildings = () => {
  ...
  // 4. Added "path" property to all objects in the array
  const projectsData = [
    {
      id: 1,
      ...
      alignRight: false,
      imageUrl: Icon1,
      path: "/projectdetail" // Temporary path
    },
    {
      id: 2,
    ...
    <section className="featured-section">
      <div className="structural-header">
        ...
        <div className="header-word-mask">
          <h1 className="header-left plus-font">SUSTAINABLE</h1>
        </div>
        <div className="header-word-mask">
          <h1 className="header-right plus-font">GREEN BUILDINGS</h1>
        </div>
      </div>
...
export default SustainableGreenBuildings;