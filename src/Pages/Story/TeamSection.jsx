        ...
        <div className="team-body locked-row">
          ...
          <div className="team-pinned-sidebar">
            <div className="team-sidebar-inner">
              <h1 className='titleteam plus-font tit'>Our Team of <br/>Experts</h1>
              <p className='plus-font des'>
              ...
              <div className="join-team">
                <span className="sdes">Join Our Team</span>
            ...
            {teamData.map((member) => (
              ...
              >
                ...
                <div className="team-details">
                  <h3 className='stit plus-font'>{member.name}</h3>
                  <p className='sdes plus-font'>{member.role}</p>
                </div>
              </div>
            ))}
          </div>
